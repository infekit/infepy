...
# %% auto 0
__all__ = ['read_toml', 'multiple_targets', 'read_k_file', 'read_csv_file', 'from_df_to_np', 'to_ls_dyna']
...
def read_k_file(path_to_file: str # File to read from 
    ...
    assert os.path.exists(path_to_file), "Wrong path. Path not existent. Check the name/extension of the file.s"
