...
# %% auto 0
__all__ = ['logger', 'config', 'source', 'target', 'read_toml', 'read_nodes', 'read_landmarks', 'write_output']
...
logging.basicConfig(
    ...
    level=logging.DEBUG,
    force=True,
    format="[%(asctime)-15s] %(levelname)-8s %(filename)s %(funcName)s line %(lineno)d %(message)s",
)
